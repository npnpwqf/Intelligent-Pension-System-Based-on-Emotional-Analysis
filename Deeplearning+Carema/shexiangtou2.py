    ...
    while cam.isOpened():
        ...
        if ret == True:#是否正常打开
            ...
            if (c % timeF == 0):  # 每隔timeF帧进行存储操作
                ...
                # track
                track_msg = track.test_track(picpath=picpath, picname=picname, timestamp=timestamp)
                if track_msg:
                    sendEvent.postMsg(track_msg, picpath)
